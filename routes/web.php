...
Route::group(['middleware' => ['auth', 'active']], function() {
	...
	Route::get('sales/getlivraison/{id}', 'SaleController@getLivraison')->name('sale.getlivraison');
	...
	Route::get('referral/calcul', 'ReferralController@calcul')->name('referral.calcul');
	...
	Route::post('user/vip', 'UserController@vip')->name('user.vip');
	Route::get('user/slugy', 'UserController@slugifyAll')->name('user.slugy');
	...
	Route::get('setting/livraison_setting', 'SettingController@livraisonSetting')->name('setting.livraison');
	Route::post('setting/general_setting_store', 'SettingController@generalSettingStore')->name('setting.generalStore');
	Route::post('setting/livraison_store', 'SettingController@livraisonStore')->name('setting.livraisonStore');
