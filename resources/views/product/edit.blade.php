                        ...
                        <form id="product-form">
                            ...
                            <div class="row">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{asset('public/images/product/'.$image)}}" height="60" width="60">
                                        ...
                                        <table id="variant-table" class="table table-hover variant-list">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input readonly type="text" class="form-control" name="variant_name[]" value="{{$variant->name}}" /></td>
                                                    <td><input readonly type="text" class="form-control" name="item_code[]" value="{{$variant->pivot['item_code']}}" /></td>
                                                    <td><div class="input-group colorpicker-class"><input name="variant_color[]" type="text" class="form-control" value="{{$variant->pivot['variant_color']}}"><div class="input-group-append"><span class="input-group-text"><i class="fa-solid fa-square" style="background-color: {{$variant->pivot['variant_color']}}; color: {{$variant->pivot['variant_color']}}; width: 24px; border-radius: 5px;"></i></i></span></div></div></td>
                                ...
                                <div class="col-md-12 mt-2">
                                    <input type="hidden" name="vip_hidden" value="{{$lims_product_data->is_vip}}">
                                    <input name="is_vip" type="checkbox" id="is_vip" value="1" @if ($lims_product_data->is_vip) checked @endif>&nbsp;
                                    <label><h5>{{trans('file.Produit VIP')}}</h5></label>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
