                    ...
                    <div class="card-body">
                        ...
                        <?php echo Form::open(['route' => 'setting.generalStore', 'files' => true, 'method' => 'post']); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.API ID')); ?> *</label>
                                        <input type="text" name="api_id" class="form-control" value="<?php if($lims_general_setting_data): ?><?php echo e($lims_general_setting_data->api_id); ?><?php endif; ?>" <?php if(Auth::user()->id !== 1): ?> disabled <?php endif; ?> />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.API KEY')); ?> *</label>
                                        <input type="text" name="api_key" class="form-control" value="<?php if($lims_general_setting_data): ?><?php echo e($lims_general_setting_data->api_key); ?><?php endif; ?>" <?php if(Auth::user()->id !== 1): ?> disabled <?php endif; ?>/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
