...
<script>
    ...
    function productDetails(product, imagedata) {
        ...
        var starting_date = Date.parse(product[19]);
        var last_date = Date.parse(product[20]);
        var today_date = Date.now();

        if (user_role == '1') {
            if((product[18]) && (today_date >= starting_date) && (today_date <= last_date)) {
                htmltext = '<table class="table modal-table table-bordered"><tr class="d-none"><td><strong><?php echo e(trans("file.Type")); ?>: </strong></td><td>'+product[0]+'</td></tr><tr><td><strong><?php echo e(trans("file.name")); ?>: </strong></td><td>'+product[1]+'</td></tr><tr><td><strong><?php echo e(trans("file.Code")); ?>: </strong></td><td>'+product[2]+'</td></tr><tr class="d-none"><td><strong><?php echo e(trans("file.Brand")); ?>: </strong></td><td>'+product[3]+'</td></tr><tr><td><strong><?php echo e(trans("file.category")); ?>: </strong></td><td>'+product[4]+'</td></tr><tr><td><strong><?php echo e(trans("file.Quantity")); ?>: </strong></td><td>'+product[16]+'</td></tr><tr><td><strong><?php echo e(trans("file.Unit")); ?>: </strong></td><td>'+product[5]+'</td></tr><tr><td><strong><?php echo e(trans("file.Cost")); ?>: </strong></td><td>'+product[6]+'</td></tr><tr><td><strong><?php echo e(trans("file.Price")); ?>: </strong></td><td><del>'+product[7]+'</del>&nbsp;&nbsp;'+product[18]+'</td></tr><tr class="d-none"><td><strong><?php echo e(trans("file.Tax")); ?>: </strong></td><td>'+product[8]+'</td></tr><tr class="d-none"><td><strong><?php echo e(trans("file.Tax Method")); ?> : </strong></td><td>'+product[9]+'</td></tr><tr><td><strong><?php echo e(trans("file.Alert Quantity")); ?> : </strong></td><td>'+product[10]+'</td></tr><tr><td><strong><?php echo e(trans("file.Product Details")); ?>: </strong></td><td>'+product[11]+'</td></tr></table>';
            } else {
