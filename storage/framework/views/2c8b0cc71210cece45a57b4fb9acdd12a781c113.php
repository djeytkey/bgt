                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <h5 class="mt-2"><strong id="under_city"><?php echo e(trans('file.Frais de livraison')); ?> : <span style="color: red;"><?php echo e($lims_sale_data->livraison); ?></span> DHS</strong></h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <?php endif; ?>
                                        <div class="form-group">
                                            <input type="hidden" id="livraison" name="livraison" value="<?php echo e($lims_sale_data->livraison); ?>" />
    ...
    $('select[name="customer_city"]').on('change', function() {
        ...
        $.ajax({
            ...
            success:function(data) {
                $("#livraison").val(data);
                $("#under_city").html("<?php echo e(trans('file.Frais de livraison')); ?> : <span style=\"color: red;\">" + data + "</span> DHS");
            },
            error:function(data){
                alert("No livraison available for sale !");
