                        ...
                        <form id="product-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-2">
                                    <input type="hidden" name="vip_hidden" value="<?php echo e($lims_product_data->is_vip); ?>">
                                    <input name="is_vip" type="checkbox" id="is_vip" value="1" <?php if($lims_product_data->is_vip): ?> checked <?php endif; ?>>&nbsp;
                                    <label><h5><?php echo e(trans('file.Produit VIP')); ?></h5></label>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\bougteba\resources\views/product/edit.blade.php ENDPATH**/ ?>