 <?php $__env->startSection('content'); ?>
    ...
    <section class="no-search">
        <div class="container-fluid">
                            ...
                            <div class="d-tc">
                                <div class="input-group">
                                    <input type="text" class="daterangepicker-field form-control"
                                        value="<?php echo e($starting_date); ?> To <?php echo e($ending_date); ?>" required />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="d-tc">
                                <input type="text" name="search_string" id="search_string" class="form-control"
                                    placeholder="<?php echo e(trans('file.Type to search...')); ?>">
                                <p class="no-mb">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="d-tc">
                                <select id="status_id" name="status_id" class="selectpicker form-control"
                                    ...
                                    <option value="13"><?php echo e(trans('file.Annulé ( SUIVI )')); ?></option>
                                    <option value="4"><?php echo e(trans('file.Livré')); ?></option>
                                    <option value="3"><?php echo e(trans('file.Mise en distribution')); ?></option>
                                    <option value="7"><?php echo e(trans('file.Erreur Numéro')); ?></option>
                                    <option value="14"><?php echo e(trans('file.client intéressé')); ?></option>
                                    <option value="15"><?php echo e(trans('file.En cours')); ?></option>
                                    <option value="5"><?php echo e(trans('file.Pas de réponse + SMS')); ?></option>
                                    <option value="16"><?php echo e(trans('file.Pas de reponse ( SUIVI )')); ?></option>
                                    <option value="17"><?php echo e(trans('file.En Voyage')); ?></option>
                                    <option value="18"><?php echo e(trans('file.Hors-zone')); ?></option>
                                    <option value="1"><?php echo e(trans('file.Ramassé')); ?></option>
                                    <option value="8"><?php echo e(trans('file.Reporté')); ?></option>
                                    <option value="19"><?php echo e(trans('file.Reporté ( SUIVI )')); ?></option>
                                    <option value="9"><?php echo e(trans('file.Programmé')); ?></option>
                                    <option value="20"><?php echo e(trans('file.Reçu')); ?></option>
                                    <option value="11"><?php echo e(trans('file.Refusé')); ?></option>
                                    <option value="12"><?php echo e(trans('file.Retourné')); ?></option>
                                    <option value="21"><?php echo e(trans('file.En retour par AMANA')); ?></option>
                                    <option value="22"><?php echo e(trans('file.Reporté aujourd hui')); ?></option>
                                    <option value="2"><?php echo e(trans('file.Expédié')); ?></option>
                                    <option value="23"><?php echo e(trans('file.Expédier par AMANA')); ?></option>
                                    <option value="6"><?php echo e(trans('file.Injoignable')); ?></option>
                                    <option value="24"><?php echo e(trans('file.Injoignable ( SUIVI )')); ?></option>
                                    <option value="25"><?php echo e(trans('file.Boite Vocal')); ?></option>
                                    <option value="26"><?php echo e(trans('file.Boite Vocal ( SUIVI )')); ?></option>
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-1 mt-3">
                        <div class="form-group">
                            <button class="btn btn-primary" id="filter-btn"
                                type="submit"><?php echo e(trans('file.submit')); ?></button>
                        </div>
                    </div>
                </div>
                <?php echo Form::close(); ?>
            ...
            <a href="<?php echo e(route('sales.index')); ?>" class="btn btn-success"><i class="dripicons-list"></i>
                <?php echo e(trans('file.Sales List')); ?></a>&nbsp;
            <?php if(Auth::user()->role_id < 2): ?>
                <a href="<?php echo e(url('sales/export')); ?>" class="btn btn-primary"><i class="dripicons-list"></i>
                    <?php echo e(trans('file.Export List')); ?></a>
            <?php endif; ?>
        </div>
            ...
            <table id="delivery-table" class="table sale-list stripe" style="width: 100%">
                <thead>
                    <tr>
                        ...
                        <th class="not-exported"><?php echo e(trans('file.API')); ?></th>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <button class="btn btn-default btn-sm d-print-none"><i class="dripicons-mail"></i>
                                <?php echo e(trans('file.Email')); ?></button>
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 id="exampleModalLabel" class="modal-title"><?php echo e(trans('file.All')); ?> <?php echo e(trans('file.Payment')); ?>
            ...
            $.get('sales/getpayment/' + id, function(data) {
                ...
                $.each(payment_date, function(index) {
                    ...
                    if (paying_method[index] != 'Paypal')
                        ...
                        payment_id[index] +
                        '" data-clicked=false data-toggle="modal" data-target="#edit-payment"><i class="dripicons-document-edit"></i> <?php echo e(trans('file.edit')); ?></button></li><li class="divider"></li><?php echo e(Form::open(['route' => 'sale.delete-payment', 'method' => 'post'])); ?><li><input type="hidden" name="id" value="' +
                        payment_id[index] +
                        '" /> <button type="submit" class="btn btn-link" onclick="return confirmPaymentDelete()"><i class="dripicons-trash"></i> <?php echo e(trans('file.delete')); ?></button></li><?php echo e(Form::close()); ?></ul></div></td>';
                    else
                        cols +=
        ...
        function deliveryDetails(delivery) {
            ...
            $.get('delivery/delivery_status/' + delivery[3], function(data) {
                ...
                $.each(status, function(index) {
                    ...
                    var trimed_comment = comment[index].trim();
                    var splited_comment = trimed_comment.split("Commentaire: ");
                    if (splited_comment.length == 2) {
                        var comment_to_show = splited_comment[1];
                    } else {
                        var last_comment = splited_comment[0].split(" | ");
                        if (last_comment.length == 2)
                            var comment_to_show = splited_comment[0].replace(" | ", "<br/>");
                        else    
                            var comment_to_show = splited_comment[0];
                    }

                    cols += '<td>' + status_date[index] + '<br /><b>' + comment_to_show + '</b></td>';
                    newRow.append(cols);
                    newBody.append(newRow);
                });
