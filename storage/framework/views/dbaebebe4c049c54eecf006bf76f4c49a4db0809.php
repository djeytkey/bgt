    ...
    <?php if(session()->has('message1')): ?>
        <div class="alert alert-success alert-dismissible text-center"><button type="button" class="close"
                data-dismiss="alert" aria-label="Close"><span
                    aria-hidden="true">&times;</span></button><?php echo session()->get('message1'); ?></div>
    <?php endif; ?>
    ...
    <section>
        <?php if(in_array('users-add', $all_permission)): ?>
            <div class="container-fluid">
                <a href="<?php echo e(route('user.create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i>
            ...
            <table id="user-table" class="table">
                <thead>
                    <tr>
                        ...
                        <th><?php echo e(trans('file.VIP')); ?></th>
                ...
                <tbody>
                    <?php $__currentLoopData = $lims_user_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-id="<?php echo e($user->id); ?>">
                            ...
                            <td>
                                <input type="checkbox" data-id="<?php echo e($user->id); ?>" data-toggle="toggle" data-size="xs"
                                    data-style="slow" data-on="<?php echo e(trans('file.Oui')); ?>" data-off="<?php echo e(trans('file.No')); ?>" data-onstyle="success" data-offstyle="danger" class="vip-checkbox" value="<?php echo e($user->is_vip); ?>" <?php if($user->is_vip): ?> checked <?php endif; ?>>
                            </td>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default"
                                        ...
                                        <?php if(in_array('users-edit', $all_permission)): ?>
                                            <li>
                                                <a href="<?php echo e(route('user.edit', $user->id)); ?>" class="btn btn-link"><i
                                        ...
                                        <?php if($user->is_active): ?>
                                            <li>
                                                <a href="<?php echo e(route('impersonate', $user->id)); ?>" class="btn btn-link"><i
                                                        class="dripicons-swap"></i> Connect</a>
                                            </li>
                                        <?php endif; ?>
                                        <li class="divider"></li>
