...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(url('public/logo/favicon-bgt.png', '')); ?>" />
                        ...
                        <ul id="setting" class="collapse list-unstyled ">
                            ...
                            <?php if($general_setting_permission_active): ?>
                                ...
                                <li id="livraison-menu"><a
                                        href="<?php echo e(route('setting.livraison')); ?>"><?php echo e(trans('file.Delivery Setting')); ?></a>
                                </li>
                            <?php endif; ?>
                            <li id="user-menu"><a
                            ...
                            <?php if(!$lims_retrait_data->demande_r): ?>
                                ...
                                <?php else: ?>
                                    <p style="text-align: center;"><?php echo e(trans('file.Il vous reste')); ?> <b
                                            style="color: red;"><?php echo e(2 - $diff); ?> <?php echo e(trans('file.jours')); ?></b>
